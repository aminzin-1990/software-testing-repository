...
try:
    ...
    address_1 = browser.find_element_by_name("address1")
    ...
    email_registration_page = browser.find_element_by_name("email")
    email_registration_page.send_keys(email_address)

    password_registration_page = browser.find_element_by_name("password")
    password_registration_page.send_keys(password_text)

    confirmed_password = browser.find_element_by_name("confirmed_password")
    confirmed_password.send_keys(password_text)

    create_button = browser.find_element_by_name("create_account")
    create_button.click()
    ...
    email_main_page = browser.find_element_by_name("email")
    email_main_page.send_keys(email_address)

    password_main_page = browser.find_element_by_name("password")
